...
export default function Home() {
  return (
    <div className="overflow-x-hidden w-full min-h-screen bg-gradient-to-br from-[#ffffff] via-[#fff5f5] to-[#fefce8] dark:from-neutral-900 dark:via-neutral-950 dark:to-neutral-900 transition-colors duration-500">
      ...
      {/* trusted section */}
      <section className='w-full flex flex-col justify-center items-center gap-3 p-5 pt-10 pb-20'>
        <p className='text-neutral-400 text-sm font-semibold'>Dipercaya oleh Perusahan & Komunitas</p>
        <div className='w-full flex flex-wrap justify-center items-center gap-10'>
          <img src="/forest.png" className='w-[10rem] grayscale opacity-50' alt="forest" />
          <img src="/ych.png" className='w-[10rem] grayscale opacity-50' alt="ych" />
          <img src="/antartika2.png" className='w-[10rem] grayscale opacity-50' alt="antartika2" />
        </div>
      </section>

      {/* We Connect Your Big Ideas Section */}
      <section className="w-full flex flex-col items-center justify-center text-center px-4 py-20 transition-colors duration-500">
        ...
        <p className="text-gray-600 dark:text-neutral-400 max-w-2xl mb-10">
          Bringing every detail of your unique message to life with powerful, resonant design that goes beyond aesthetics.
        </p>

        <div className="grid md:grid-cols-2 gap-10 max-w-5xl text-left">
          {/* Left Column */}
          <div className="space-y-8">
            <div>
              <h3 className="font-semibold text-lg flex items-center gap-2 dark:text-white">
                <span className="text-[#fb835b]">✦</span> Promote Innovation and Adaptability
              </h3>
            ...
            <div>
              <h3 className="font-semibold text-lg flex items-center gap-2 dark:text-white">
                <span className="text-[#fb835b]">✦</span> Deliver High-Impact Solutions
              </h3>
              <p className="text-gray-600 dark:text-neutral-400 text-sm mt-1">
            ...
            <div>
              <h3 className="font-semibold text-lg flex items-center gap-2 dark:text-white">
                <span className="text-[#fb835b]">✦</span> Build Trust and Long-Term Relationships
              </h3>
              <p className="text-gray-600 dark:text-neutral-400 text-sm mt-1">
          ...
          <div className="space-y-8">
            <div>
              <h3 className="font-semibold text-lg flex items-center gap-2 dark:text-white">
                <span className="text-[#fb835b]">✦</span> Create Meaningful Engagement
              </h3>
              <p className="text-gray-600 dark:text-neutral-400 text-sm mt-1">
            ...
            <div>
              <h3 className="font-semibold text-lg flex items-center gap-2 dark:text-white">
                <span className="text-[#fb835b]">✦</span> Champion a Collaborative Process
              </h3>
              <p className="text-gray-600 dark:text-neutral-400 text-sm mt-1">
            ...
            <div>
              <h3 className="font-semibold text-lg flex items-center gap-2 dark:text-white">
                <span className="text-[#fb835b]">✦</span> Drive Consistency and Clarity
              </h3>
              <p className="text-gray-600 dark:text-neutral-400 text-sm mt-1">
      ...
      <section className="w-full flex flex-col items-center justify-center text-center px-4 py-20 transition-colors duration-500">
        ...
        <p className="text-gray-600 dark:text-neutral-400 max-w-2xl mb-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 max-w-6xl w-full">
          {/* Service 1 */}
          <div className="flex flex-col text-start p-6 bg-white dark:bg-neutral-950 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
            <FontAwesomeIcon icon={faPalette} className="mb-5 text-2xl text-[#fb835b] dark:text-white" />
            <h3 className="font-semibold text-lg dark:text-white">Graphic Design & Branding</h3>
          ...
          {/* Service 2 */}
          <div className="flex flex-col text-start p-6 bg-white dark:bg-neutral-950 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
            <FontAwesomeIcon icon={faCode} className="mb-5 text-2xl text-[#fb835b] dark:text-white" />
            <h3 className="font-semibold text-lg dark:text-white">Web Development</h3>
            <p className="text-gray-600 dark:text-neutral-400 text-sm mt-2">
          ...
          {/* Service 3 */}
          <div className="flex flex-col text-start p-6 bg-white dark:bg-neutral-950 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
            <FontAwesomeIcon icon={faBullhorn} className="mb-5 text-2xl text-[#fb835b] dark:text-white" />
            <h3 className="font-semibold text-lg dark:text-white">Digital Marketing</h3>
            <p className="text-gray-600 dark:text-neutral-400 text-sm mt-2">
          ...
          {/* Service 4 */}
          <div className="flex flex-col text-start p-6 bg-white dark:bg-neutral-950 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
            <FontAwesomeIcon icon={faObjectGroup} className="mb-5 text-2xl text-[#fb835b] dark:text-white" />
            <h3 className="font-semibold text-lg dark:text-white">UI/UX Design</h3>
            <p className="text-gray-600 dark:text-neutral-400 text-sm mt-2">
      ...
      {/* Stats Section */}
      <section className="w-full flex justify-center items-center px-4 py-2 transition-colors duration-500">
        <div className="max-w-6xl w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Card 1 */}
          <div className="bg-white dark:bg-neutral-950 rounded-2xl shadow-sm p-10 flex flex-col justify-center items-center text-center hover:shadow-md transition-all duration-300">
            <h3 className="text-5xl font-bold text-black dark:text-white mb-2">98%</h3>
          ...
          {/* Card 2 */}
          <div className="bg-white dark:bg-neutral-950 rounded-2xl shadow-sm p-10 flex flex-col justify-center items-center text-center hover:shadow-md transition-all duration-300">
            <h3 className="text-5xl font-bold text-black dark:text-white mb-2">15,000</h3>
            <p className="text-gray-600 dark:text-neutral-400 text-sm">
          ...
          {/* Card 3 */}
          <div className="bg-white dark:bg-neutral-950 rounded-2xl shadow-sm p-10 flex flex-col justify-center items-center text-center hover:shadow-md transition-all duration-300">
            <h3 className="text-5xl font-bold text-black dark:text-white mb-2">10K+</h3>
            <p className="text-gray-600 dark:text-neutral-400 text-sm">
