    ...
    <>
      ...
      >
        ...
        <motion.button
          ...
          animate={isHovered ? 'hover' : 'idle'}
          whileTap="click"
          className={`relative w-16 h-16 rounded-full bg-gradient-to-br from-white/90 to-white/70 dark:from-neutral-800/90 dark:to-neutral-900/70 backdrop-blur-xl border border-white/20 dark:border-neutral-700/30 shadow-2xl flex items-center justify-center group overflow-hidden transition-opacity duration-300 ${
